...
public class AidsV1 {
    ...
    public AidsV1(@NonNull String cardType, @NonNull String cardName, @NonNull String selectPpseCommand, @NonNull String selectPpseResponse, @NonNull int numberOfAid, @NonNull Aid[] aid) {
    ...
    public AidsV1(@NonNull String cardType, @NonNull String cardName, @NonNull String selectPpseCommand, @NonNull String selectPpseResponse, @NonNull int numberOfAid) {
        this.cardType = cardType;
        this.cardName = cardName;
        this.selectPpseCommand = selectPpseCommand;
        this.selectPpseResponse = selectPpseResponse;
