...
public class FilesModelV1 {
    ...
    public FilesModelV1(@NonNull String address, @NonNull String content, @NonNull String sfi, @NonNull String record, @NonNull String length, @NonNull String offlineAuth, @NonNull String containsTrack2Data, @NonNull String track2Data, @NonNull String panT2D, @NonNull String expDateT2D, @NonNull String containsPan, @NonNull String pan, @NonNull String expDate) {
