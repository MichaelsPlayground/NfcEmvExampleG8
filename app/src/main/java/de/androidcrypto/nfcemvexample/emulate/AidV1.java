...
public class AidV1 {
    ...
    public AidV1(@NonNull String aid, @NonNull String aidName, @NonNull String selectAidCommand, @NonNull String selectAidResponse, @NonNull String getProcessingOptionsCommand, @NonNull String getProcessingOptionsResponse, @NonNull int checkFirstBytesGetProcessingOptions, @NonNull String panFoundInTrack2Data, @NonNull String panFoundInFiles, @NonNull int numberOfFiles, @NonNull String afl, FilesModel[] files) {
        this.aid = aid;
