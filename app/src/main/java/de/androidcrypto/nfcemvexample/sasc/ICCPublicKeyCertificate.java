...
public class ICCPublicKeyCertificate {
    ...
    private byte[] offlineDataAuthenticationRecords;
    ...
    public ICCPublicKeyCertificate(byte[] offlineDataAuthenticationRecords, IssuerPublicKeyCertificate issuerPublicKeyCert) {
        this.offlineDataAuthenticationRecords = offlineDataAuthenticationRecords;
...
//        }
    ...
    public boolean validate() {
        ...
        hashStream.write(offlineDataAuthenticationRecords, 0, offlineDataAuthenticationRecords.length);
