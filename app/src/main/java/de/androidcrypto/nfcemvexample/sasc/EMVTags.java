...
import de.androidcrypto.nfcemvexample.sasc.mastercard.MCTags;
import de.androidcrypto.nfcemvexample.sasc.visa.VISATags;
...
public class EMVTags {
    ...
    /*
    public static Tag getNotNull(sasc.emv.EMVApplication app, Tag tag) {
